module github.com/agentflare-ai/agentml-go/ollama

go 1.24.5

require (
	github.com/agentflare-ai/agentml-go v0.0.0-00010101000000-000000000000
	github.com/agentflare-ai/agentml-go/prompt v0.0.0-00010101000000-000000000000
